...
> Self-marked: the maintainer chose SQLite, which handles locking natively. Retained for reference.
...
## References
- `php/signIn.php:12-14`, `php/forgotPassword.php:19-21`, `php/getTempPass.php:22-24`
