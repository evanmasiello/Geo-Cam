                ...
                if (xmlhttp.responseText == "noLocation") {
                   ...
                   //console.log("bad response");
                    ...
                    window.onresize = function() { 
                        ...
                        while (window.innerHeight > document.body.clientHeight && count <= 100 && maxNotHit) {
                            if (imageArray.length > 0) fillPics(imagesToDisplay);
                        setPadderHeight();
                        count++;
                        }
            ...
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    ...
                    if (response.charAt(0) == '{') {
                        ...
                        if (document.getElementById("comments" + id).innerHTML == commentFillerString) {
    ...
    //if (session !== "") {
        ...
        for (var c=0; c < counter; c++) {
            ...
            if (imageArray[c].hidden) {
                ...
                document.getElementById("likes" + Id).innerHTML = displayNum(imageArray[c].likes);
