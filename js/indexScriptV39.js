                  ...
                  //console.log("server response: " + xmlhttp.responseText);
                   ...
                   //console.log("likesMean = " + likesMean);
                    ...
                    for (i = 0; i < imageArray.length; i++) {
                        ...
                        likesDevTotal += Math.abs(imageArray[i].likes - likesMean);
                    }

                    var timeStDev = timeDevTotal / imageArray.length;
                    var distStDev = distDevTotal / imageArray.length;
                    var likesStDev = likesDevTotal / imageArray.length;
                   ...
                   //console.log("likesStDev = " + likesStDev);
                    ...
                    for (i = 0; i < imageArray.length; i++) {
                        ...
                        imageArray[i].zLikes = (imageArray[i].likes - likesMean) / likesStDev;
                        
                        //console.log("z score for time: " + imageArray[i].zTime);
                        //console.log("z score for likes: " + imageArray[i].zLikes);
                    }
