...
function showMyPosts() {
    ...
    for (var c=0; c < imageArray.length; c++) {
        if (imageArray[c].hidden != true) postCount++;
    }
    ...
    if (id == userId) {
        ...
        document.getElementById("thisUserMy").innerHTML = "This user has made ";
        document.getElementById("thisUser2My").innerHTML = "This user has made ";
    }
    document.getElementById("profilePostCountMy").innerHTML = displayNum(arrayOfPosts.length, false);
